...
#
# Generated by export_simulation on Sun Oct 22 19:51:53 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './rom_32x1024.sh' script.

./rom_32x1024.sh -reset_run
...
./rom_32x1024.sh -noclean_files

For more information on the script, please type './rom_32x1024.sh -help'.
