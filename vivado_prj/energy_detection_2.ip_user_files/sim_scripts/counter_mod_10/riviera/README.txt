...
#
# Generated by export_simulation on Fri Sep 15 14:11:31 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './counter_mod_10.sh' script.

./counter_mod_10.sh -reset_run
...
./counter_mod_10.sh -noclean_files

For more information on the script, please type './counter_mod_10.sh -help'.
