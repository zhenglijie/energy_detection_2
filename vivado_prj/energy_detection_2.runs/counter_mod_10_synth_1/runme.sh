...
HD_PWD='F:/Users/Lenovo/Desktop/fpga_zynq/energy_detection_2/vivado_prj/energy_detection_2.runs/counter_mod_10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_mod_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_mod_10.tcl
