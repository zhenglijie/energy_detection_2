...
HD_PWD='F:/Users/Lenovo/Desktop/fpga_zynq/energy_detection_2/vivado_prj/energy_detection_2.runs/rom_32x1024_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_32x1024.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_32x1024.tcl
