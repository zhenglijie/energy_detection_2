...
HD_PWD='F:/Users/Lenovo/Desktop/fpga_zynq/energy_detection_2/vivado_prj/energy_detection_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log energy_detection_fixed_th.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source energy_detection_fixed_th.tcl
