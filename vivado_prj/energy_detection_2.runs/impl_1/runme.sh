...
HD_PWD='F:/Users/Lenovo/Desktop/fpga_zynq/energy_detection_2/vivado_prj/energy_detection_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log energy_detection_fixed_th.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source energy_detection_fixed_th.tcl -notrace
